      ...
      <main className="max-w-7xl mx-auto py-8 px-4 md:px-6">
        ...
        <div className="max-w-2xl">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-8">
              <h2 className="text-2xl font-bold mb-6">{t("page.childcare.title")}</h2>

              <RadioGroup value={selectedOption || ""} onValueChange={setSelectedOption}>
                <div className="space-y-6">
                  <div className="flex items-start space-x-3">
                    <RadioGroupItem id="arrangements" value="arrangements" className="mt-1" />
                    <div>
                      <Label htmlFor="arrangements" className="text-lg font-medium">
                        {t("page.childcare.arrangements")}
                      </Label>
                      <p className="text-gray-600 mt-1">{t("page.childcare.arrangements.description")}</p>
                    </div>
                  </div>

                  <div className="flex items-start space-x-3">
                    <RadioGroupItem id="adoption" value="adoption" className="mt-1" />
                    <div>
                      <Label htmlFor="adoption" className="text-lg font-medium">
                        {t("page.childcare.adoption")}
                      </Label>
                      <p className="text-gray-600 mt-1">{t("page.childcare.adoption.description")}</p>
                    </div>
                  </div>
