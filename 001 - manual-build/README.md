...
The applications's home page will be available at http://localhost:3099
...
(set to `3099` in this template app).

In order to test if the application is up, you can visit https://localhost:3099 in your browser.
...
The application exposes a health endpoint (https://localhost:3099/health), created with the use of
